...
public class remstatus extends JFrame implements ActionListener, Printable
{
    ...
    public remstatus(int m, int y)
    {
        ...
        try
        {
            ...
            c2.rs=c2.st.executeQuery("select count(b.asn) from basic b, payment p, subdetails s where b.asn=p.asn and s.asn=p.asn and p.asn in (select asn from payment where endm="+(m22)+" and endy="+y22+") and s.state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK')");
            c2.rs.next();
            m_2[8].setText(""+c2.rs.getInt(1));
            
            c2.rs=c2.st.executeQuery("select count(b.asn) from basic b, payment p, subdetails s where b.asn=p.asn and s.asn=p.asn and p.asn in (select asn from payment where endm="+(m21)+" and endy="+y21+") and s.state  not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK')");
            c2.rs.next();
            m_1[8].setText(""+c2.rs.getInt(1));
            
            c2.rs=c2.st.executeQuery("select count(b.asn) from basic b, payment p, subdetails s where b.asn=p.asn and s.asn=p.asn and p.asn in (select asn from payment where endm="+(m)+" and endy="+y+") and s.state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK')");
            c2.rs.next();
            m_c[8].setText(""+c2.rs.getInt(1));
            
            c2.rs=c2.st.executeQuery("select count(b.asn) from basic b, payment p, subdetails s where b.asn=p.asn and s.asn=p.asn and p.asn in (select asn from payment where endm="+(m11)+" and endy="+y11+") and s.state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK')");
            c2.rs.next();
            m1[8].setText(""+c2.rs.getInt(1));
            
            c2.rs=c2.st.executeQuery("select count(b.asn) from basic b, payment p, subdetails s where b.asn=p.asn and s.asn=p.asn and p.asn in (select asn from payment where endm="+(m12)+" and endy="+y12+") and s.state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK')");
            c2.rs.next();
            ...
            c2.rs=c2.st.executeQuery("select count(b.asn) from basic b, payment p, subdetails s where b.asn=p.asn and s.asn=p.asn and p.asn in (select asn from payment where endm="+(m)+" and endy="+y+") and s.state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK') and b.dist='By Hand' ");
            c2.rs.next();
            hand[8].setText(""+c2.rs.getInt(1));
            
            c2.rs=c2.st.executeQuery("select count(b.asn) from basic b, payment p, subdetails s where b.asn=p.asn and s.asn=p.asn and p.asn in (select asn from payment where endm="+(m)+" and endy="+y+") and s.state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK') and b.dist='By Post'");
            c2.rs.next();
            post[8].setText(""+c2.rs.getInt(1));
            
            c2.rs=c2.st.executeQuery("select count(b.asn) from basic b, payment p, subdetails s where b.asn=p.asn and s.asn=p.asn and p.asn in (select asn from payment where endm="+(m)+" and endy="+y+") and s.state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK') and b.dist='Distributor'");
            c2.rs.next();
