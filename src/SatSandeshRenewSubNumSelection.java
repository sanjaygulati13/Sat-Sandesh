...
public class SatSandeshRenewSubNumSelection extends JFrame implements ActionListener {
    ...
    public SatSandeshRenewSubNumSelection() {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == ok) {
            ...
            new SatSandeshRenewSubscription(stat, sub);
            this.dispose();
        }
