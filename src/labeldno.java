...
public class labeldno implements Printable, ActionListener
{
	public static void main(String args[])
	{
		new labeldno(1, 7, 2009);
	}
	int present;
		...
		if(chk%2==1 && (end-start)!=lineHeight)
		{
			...
			for(int line=start; line<end; line+=2)
			{
				...
				if(i%(linesPerPage/2)==1)
				{
					...
					g.drawString("LIST OF CURRENT SAT-SANDESH MEMBERS SERVICED BY DISTRIBUTOR CODE # "+dno+" ( "+dist+" , "+state+" )", (int)pf.getWidth()/2-320,y);
