...
public class index implements Printable, ActionListener
{
	public static void main(String args[])
	{
            index index = new index(1,12,2011);
	}
	int present=0;
	int[] pageBreak;
	int numLines=0;
	...
	public index(int d2,int m2, int y2)
	{
		...
		if(chk%2==1 && (end-start)!=lineHeight)
		{
			...
			for(int line=start; line<end; line+=2)
			{
				if(i%(linesPerPage/2)==1)
				{
					...
					g.drawString("SAT SANDESH INDEX REGISTER AS ON "+d+"-"+m+"-"+y1, (int)pf.getWidth()/2-100,y);
