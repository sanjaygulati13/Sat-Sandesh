...
public class InventorySubIssueDetailsClass implements ActionListener, ItemListener
{
    ...
    InventorySubIssueDetailsClass()
    {
        ...
        subIssueReceiptBookWindow = new JFrame("Re-Issue a Receipt Book");
        ...
        subIssueReceiptBookWindow.add(issuedToStallText, "span 2, w 100!");
        subIssueReceiptBookWindow.add(issueDateLabel);
        subIssueReceiptBookWindow.add(issueDatetext, "split 3, w 20!");
        subIssueReceiptBookWindow.add(issueDateMonthtext, " w 20!");
        subIssueReceiptBookWindow.add(issueDateYearText, "w 40! , wrap 20px");
