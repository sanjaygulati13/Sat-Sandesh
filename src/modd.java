...
public class modd extends JFrame implements ActionListener
{
	...
	JLabel nam, phno, moddcd, email, add1, rem, hist, dist, stat, pin;
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==mod)
		{
			...
			try
			{
					...
					c1.a=c1.st.executeUpdate("update despcode set fname='"+name1+"', lname='"+lname1+"',phone='"+phone+"',email='"+email+"',add1='"+add1+"',add2='"+add2+"',add3='"+add3+"',remarks='"+remarks+"',history='"+history+"',district='"+district+"',state='"+state+"',pinno="+pinno+" where dno="+dno);
					if(c1.a==1)
					{
