...
public class SatSandeshReminderStatusPrint extends JFrame implements ActionListener, Printable
{
	public static void main(String args[])
	{
		new SatSandeshReminderStatusPrint(11,2017);
	}
	...
	String state[]={"DL","HAR","MAH","MP","PJB","RAJ","UK","UP","MS","TOTAL"};
	...
	public SatSandeshReminderStatusPrint(int m, int y)
	{
		...
		try
		{
			for(int i=0;i<8;i++)
			{
				...
				connect c1=new connect();
                                String ending_period = y22+"-"+m22+"-28";
				c1.rs=c1.st.executeQuery("select count(asn) from subscribers_primary_details "
                                        + "where state = '"+state[i]+"' and ending_period = '"+ending_period+"'");
                                        //+ "(select asn from payment where endm="+m22+" and endy="+y22+") and s.state='"+state[i]+"'");
				c1.rs.next();
				m_2[i].setText(""+c1.rs.getInt(1));

                                ending_period = y12+"-"+m12+"-28";
				c1.rs=c1.st.executeQuery("select count(asn) from subscribers_primary_details "
                                        + "where state = '"+state[i]+"' and ending_period = '"+ending_period+"'");
                                        //+ "where asn in "
                                        //+ "(select asn from payment where endm="+m12+" and endy="+y12+") and s.state='"+state[i]+"'");
				c1.rs.next();
				m_1[i].setText(""+c1.rs.getInt(1));

                                ending_period = yc+"-"+mc+"-28";
				c1.rs=c1.st.executeQuery("select count(asn) from subscribers_primary_details "
                                        + "where state = '"+state[i]+"' and ending_period = '"+ending_period+"'");
                                        //+ "where asn in "
                                        //+ "(select asn from payment where endm="+(mc)+" and endy="+yc+") and s.state='"+state[i]+"'");
				c1.rs.next();
				m_c[i].setText(""+c1.rs.getInt(1));

                                ending_period = y11+"-"+m11+"-28";
				c1.rs=c1.st.executeQuery("select count(asn) from subscribers_primary_details "
                                        + "where state = '"+state[i]+"' and ending_period = '"+ending_period+"'");
                                        //+ "where asn in "
                                        //+ "(select asn from payment where endm="+(m11)+" and endy="+y11+") and s.state='"+state[i]+"'");
				c1.rs.next();
				...
				total1[i].setText(""+(Integer.parseInt(m_2[i].getText())+Integer.parseInt(m_1[i].getText())+Integer.parseInt(m_c[i].getText())+Integer.parseInt(m1[i].getText())+Integer.parseInt(m2[i].getText())));
                                ...
                                ending_period = y+"-"+m+"-28";
				c1.rs=c1.st.executeQuery("select count(asn) from subscribers_primary_details "
                                        + "where state = '"+state[i]+"' and ending_period = '"+ending_period+"' and distribution_type = 'By Hand'");
                                        //+ "where asn in "
                                        //+ "(select asn from payment where endm="+(m)+" and endy="+y+") and s.state='"+state[i]+"' "
                                        //+ "and b.dist='By Hand' ");
				c1.rs.next();
				hand[i].setText(""+c1.rs.getInt(1));

				c1.rs=c1.st.executeQuery("select count(asn) from subscribers_primary_details "
                                        + "where state = '"+state[i]+"' and ending_period = '"+ending_period+"' and distribution_type = 'By Post'");
                                        //+ "where asn in "
                                        //+ "(select asn from payment where endm="+(m)+" and endy="+y+") and s.state='"+state[i]+"' and b.dist='By Post'");
				c1.rs.next();
				post[i].setText(""+c1.rs.getInt(1));

				c1.rs=c1.st.executeQuery("select count(asn) from subscribers_primary_details "
                                        + "where state = '"+state[i]+"' and ending_period = '"+ending_period+"' and distribution_type = 'Distributor'");
                                        //+ "where asn in "
                                        //+ "(select asn from payment where endm="+(m)+" and endy="+y+") and s.state='"+state[i]+"' and b.dist='Distributor'");
				c1.rs.next();
			...
			connect c2=new connect();
                        ...
                        String ending_period = y22+"-"+m22+"-28";
			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK') and ending_period = '"+ending_period+"'");
                                //+ "where asn in "
                                //+ "(select asn from payment where endm="+(m22)+" and endy="+y22+") "
                                //+ "and s.state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK')");
			c2.rs.next();
			m_2[8].setText(""+c2.rs.getInt(1));

                        ending_period = y21+"-"+m21+"-28";
			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK') and ending_period = '"+ending_period+"'");
                                //+ "where asn in "
                                //+ "(select asn from payment where endm="+(m21)+" and endy="+y21+") "
                                //+ "and s.state  not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK')");
			c2.rs.next();
			...
			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK') and ending_period = '"+ending_period+"'");
                                //+ "(select asn from payment where endm="+(m)+" and endy="+y+") "
                                //+ "and s.state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK')");
			c2.rs.next();
			...
			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK') and ending_period = '"+ending_period+"'");
                                //+ "where asn in "
                                //+ "(select asn from payment where endm="+(m11)+" and endy="+y11+") "
                                //+ "and s.state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK')");
			c2.rs.next();
			...
			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK') and ending_period = '"+ending_period+"'");
                                //+ "where asn in "
                                //+ "(select asn from payment where endm="+(m12)+" and endy="+y12+") "
                                //+ "and s.state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK')");
			c2.rs.next();
			m2[8].setText(""+c2.rs.getInt(1));


			total1[8].setText(""+(Integer.parseInt(m_2[8].getText())
                                +Integer.parseInt(m_1[8].getText())
                                +Integer.parseInt(m_c[8].getText())
                                +Integer.parseInt(m1[8].getText())
                                +Integer.parseInt(m2[8].getText())));


                        ending_period = y+"-"+m+"-28";
			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK') and ending_period = '"+ending_period+"' "
                                + "and distribution_type = 'By Hand'");
                                //+ "where asn in (select asn from payment where endm="+(m)+" and endy="+y+") and "
                                //+ "s.state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK') and b.dist='By Hand' ");
			c2.rs.next();
			hand[8].setText(""+c2.rs.getInt(1));

			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK') and ending_period = '"+ending_period+"' "
                                + "and distribution_type = 'By Post'");
                                //+ "where asn in (select asn from payment where endm="+(m)+" and endy="+y+") and "
                                //+ "s.state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK') and b.dist='By Post'");
			c2.rs.next();
			post[8].setText(""+c2.rs.getInt(1));

			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK') and ending_period = '"+ending_period+"' "
                                + "and distribution_type = 'Distributor'");
                                //+ "where asn in (select asn from payment where endm="+(m)+" and endy="+y+") and "
                                //+ "s.state not in ('DL','HAR','PJB','RAJ','MP','MAH','UP','UK') and b.dist='Distributor'");
			c2.rs.next();
			...
			//++++++++++++++++++++++++++++++++++++++++++++++++++==============================================+++++++++++++++++++++++++++++++++++++
                        ...
                        ending_period = y22+"-"+m22+"-28";
			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where ending_period = '"+ending_period+"'");
                                //+ "where asn in (select asn from payment where endm="+(m22)+" and endy="+y22+")");
			c2.rs.next();
			...
			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where ending_period = '"+ending_period+"'");
                                //+ "where asn in (select asn from payment where endm="+(m21)+" and endy="+y21+")");
			c2.rs.next();
			...
			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where ending_period = '"+ending_period+"'");
                                //+ "where asn in (select asn from payment where endm="+(m)+" and endy="+y+") ");
			c2.rs.next();
			...
			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where ending_period = '"+ending_period+"'");
                                //+ "where asn in (select asn from payment where endm="+(m11)+" and endy="+y11+")");
			c2.rs.next();
			...
			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where ending_period = '"+ending_period+"'");
                                //+ "where asn in (select asn from payment where endm="+(m12)+" and endy="+y12+") ");
			c2.rs.next();
			...
			total1[9].setText(""+(Integer.parseInt(m_2[9].getText())+Integer.parseInt(m_1[9].getText())+Integer.parseInt(m_c[9].getText())+Integer.parseInt(m1[9].getText())+Integer.parseInt(m2[9].getText())));
                        ...
                        ending_period = y+"-"+m+"-28";
			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where ending_period = '"+ending_period+"' and distribution_type = 'By Hand'");
                                //+ "where asn in (select asn from payment where endm="+(m)+" and endy="+y+") and b.dist='By Hand'");
			c2.rs.next();
			hand[9].setText(""+c2.rs.getInt(1));

			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where ending_period = '"+ending_period+"' and distribution_type = 'By Post'");
                                //+ "where asn in (select asn from payment where endm="+(m)+" and endy="+y+") and b.dist='By Post'");
			c2.rs.next();
			post[9].setText(""+c2.rs.getInt(1));

			c2.rs=c2.st.executeQuery("select count(asn) from subscribers_primary_details "
                                + "where ending_period = '"+ending_period+"' and distribution_type = 'Distributor'");
                                //+ "where asn in (select asn from payment where endm="+(m)+" and endy="+y+") and b.dist='Distributor'");
			c2.rs.next();
			dist[9].setText(""+c2.rs.getInt(1));

			total2[9].setText(""+(Integer.parseInt(hand[9].getText())
                                +Integer.parseInt(post[9].getText())
                                +Integer.parseInt(dist[9].getText())));
