...
public class deactive implements Printable, ActionListener
{
    ...
    public void initLines()
    {
        try
        {
            ...
            c2.rs=c2.st.executeQuery("select b.asn from basic b, payment p, subdetails s where b.asn=p.asn and b.asn=s.asn and b.status='Deactive' and b.subnos not in ('NA') order by p.endy, p.endm, s.fname, s.lname ");
            while(c2.rs.next())
            {
