...
public class record extends JFrame implements ActionListener, Printable
{
...
//	JLabel handt1[] = new JLabel[10];
	...
	public record(int month, int year, String lang)
	{
		j=new JFrame();
		...
		try
		{
			...
			c2.rs=c2.st.executeQuery("select count(b.asn) from basic b, subdetails s, payment p where b.asn=p.asn and s.asn=p.asn and b.lang='"+lang+"' and b.status='Active'and s.state not in ('DL','HAR','MAH','MP','PJB','RAJ','UA','UP') and b.dist='By Hand'");
			while(c2.rs.next())
			{
				a1=c2.rs.getInt(1);
			}
			...
			c2.rs=c2.st.executeQuery("select count(b.asn) from basic b, subdetails s, payment p where b.asn=p.asn and s.asn=p.asn and b.lang='"+lang+"' and b.status='Active'and s.state not in ('DL','HAR','MAH','MP','PJB','RAJ','UA','UP') and b.dist='By Post'");
			while(c2.rs.next())
			{
				a2=c2.rs.getInt(1);
			}
			
			c2.rs=c2.st.executeQuery("select count(b.asn) from basic b, subdetails s, payment p where b.asn=p.asn and s.asn=p.asn and b.lang='"+lang+"' and b.status='Active'and s.state not in ('DL','HAR','MAH','MP','PJB','RAJ','UA','UP') and b.dist='Distributor'");
			while(c2.rs.next())
			{
				a3=c2.rs.getInt(1);
			}
			...
			c2.rs=c2.st.executeQuery("select b.asn from basic b, subdetails s where b.asn=s.asn and b.lang='"+lang+"' and s.state not in ('DL','HAR','MAH','MP','PJB','RAJ','UA','UP') and b.status='Active'");
				while(c2.rs.next())
				{	
					a4++;
				}
				
				c2.rs=c2.st.executeQuery("select b.asn from basic b, subdetails s where b.asn=s.asn and b.lang='"+lang+"' and s.state not in ('DL','HAR','MAH','MP','PJB','RAJ','UA','UP') and b.status='Inactive'");
				while(c2.rs.next())
				{
					a5++;
				}
				...
				c2.rs=c2.st.executeQuery("select b.asn from basic b, subdetails s where b.asn=s.asn and b.lang='"+lang+"' and s.state not in ('DL','HAR','MAH','MP','PJB','RAJ','UA','UP') and b.status='Freeze'");
				while(c2.rs.next())
				{
					a6++;
				}
				...
				c2.rs=c2.st.executeQuery("select b.asn from basic b, subdetails s where b.asn=s.asn and b.lang='"+lang+"' and s.state not in ('DL','HAR','MAH','MP','PJB','RAJ','UA','UP') and b.status='Deactive'");
				while(c2.rs.next())
				{
					a7++;
				}
			...
			c2.rs=c2.st.executeQuery("select b.asn from basic b, subdetails s where b.asn=s.asn and b.lang='"+lang+"' and (s.state not in ('DL','HAR','MAH','MP','PJB','RAJ','UA','UP') and b.dist='By Hand')");
			while(c2.rs.next())
			{
				a8++;
			}
			...
			c2.rs=c2.st.executeQuery("select b.asn from basic b, subdetails s where b.asn=s.asn and b.lang='"+lang+"' and (s.state not in ('DL','HAR','MAH','MP','PJB','RAJ','UA','UP') and b.dist='By Post')");
			while(c2.rs.next())
			{
				a9++;
			}
			
			c2.rs=c2.st.executeQuery("select b.asn from basic b, subdetails s where b.asn=s.asn and b.lang='"+lang+"' and (s.state not in ('DL','HAR','MAH','MP','PJB','RAJ','UA','UP') and b.dist='Distributor')");
			while(c2.rs.next())
			{
				a10++;
			}
